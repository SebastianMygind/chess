...
pub fn get_new_position(current_board_position: i8, chess_move: Move) -> Option<i8> {
    debug_assert!(current_board_position >= 0 && current_board_position < 64);
    let current_mailbox_pos: i8 = MAIL_BOX_64[current_board_position as usize];
